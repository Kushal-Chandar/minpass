#if !defined(MINPASS_SRC_INC_SQLITE3_CLIENT_JSON_PROCESSOR_H_)
#define MINPASS_SRC_INC_SQLITE3_CLIENT_JSON_PROCESSOR_H_
...
#endif  // MINPASS_SRC_INC_SQLITE3_CLIENT_JSON_PROCESSOR_H_
